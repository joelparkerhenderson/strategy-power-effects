...
- Why some national systems succeed while others fail
...
- Must choose: Build national system or use vendor?
...
- **National Systems**: Can compete if mandated nationally (NHS England Spine)
...
### **Strategic Implications for National Systems**
...
- Successful national systems inspire others
...
Legend:
K = Viral Coefficient 
R = Recommendations per clinician
A = Authority/credibility of recommender
I = Implementation likelihood at recommended institution
```
...
- Average switching cost: £10-50M for large hospital
...
- Each health board chose different systems historically
- Now: Difficult to standardize nationally
- Switching costs per health board: £20-40M
...
**National System Moats (NHS Spine, NDR Wales):**
✅ **Positive Effects:**
...
**National System Moat Strength (from public perspective):**
- Data sovereignty (% data in national system)
...
- FHIR-compliant APIs for all national systems
...
Healthcare is inherently multi-stakeholder. No single organization can deliver complete digital health services. Success requires orchestrating partners across:
...
**Level 1: No Ecosystem (Current Wales?)**
- Monolithic systems
...
**NHS Wales Target**: Move from Level 1 → Level 3 by 2027
...
- Layer 1: Foundation Powers
  - Scale Effects (NDR, WNCR across all health boards)
...
- Phase 1: Foundation (Years 0-3) - BUILD INFRASTRUCTURE
  ...
  - Establish national platforms (NDR, WNCR)
